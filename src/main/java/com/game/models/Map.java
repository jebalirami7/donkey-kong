...
public class Map {
    ...
    private void createLevels() {
        // Create level 1
        levels.add(new Level.Builder(root)
                .setBridgeColor(Color.rgb(225, 51, 129))
                .addBridge(List.of(1, start_y, 15)).addBridge(List.of(16, start_y - App.slope, 3))
                .addBridge(List.of(19, start_y - 2 * App.slope, 3)).addBridge(List.of(22, start_y - 3 * App.slope, 3))
                .addBridge(List.of(25, start_y - 4 * App.slope, 3)).addBridge(List.of(28, start_y - 5 * App.slope, 3))
                .addBridge(List.of(25, row2_y, 3)).addBridge(List.of(22, row2_y - App.slope, 3))
                .addBridge(List.of(19, row2_y - 2 * App.slope, 3)).addBridge(List.of(16, row2_y - 3 * App.slope, 3))
                .addBridge(List.of(13, row2_y - 4 * App.slope, 3)).addBridge(List.of(10, row2_y - 5 * App.slope, 3))
                .addBridge(List.of(7, row2_y - 6 * App.slope, 3)).addBridge(List.of(4, row2_y - 7 * App.slope, 3))
                .addBridge(List.of(2, row2_y - 8 * App.slope, 2)).addBridge(List.of(4, row3_y, 3))
                .addBridge(List.of(7, row3_y - App.slope, 3)).addBridge(List.of(10, row3_y - 2 * App.slope, 3))
                .addBridge(List.of(13, row3_y - 3 * App.slope, 3)).addBridge(List.of(16, row3_y - 4 * App.slope, 3))
                .addBridge(List.of(19, row3_y - 5 * App.slope, 3)).addBridge(List.of(22, row3_y - 6 * App.slope, 3))
                .addBridge(List.of(25, row3_y - 7 * App.slope, 3)).addBridge(List.of(28, row3_y - 8 * App.slope, 2))
                .addBridge(List.of(25, row4_y, 3)).addBridge(List.of(22, row4_y - App.slope, 3))
                .addBridge(List.of(19, row4_y - 2 * App.slope, 3)).addBridge(List.of(16, row4_y - 3 * App.slope, 3))
                .addBridge(List.of(13, row4_y - 4 * App.slope, 3)).addBridge(List.of(10, row4_y - 5 * App.slope, 3))
                .addBridge(List.of(7, row4_y - 6 * App.slope, 3)).addBridge(List.of(4, row4_y - 7 * App.slope, 3))
                .addBridge(List.of(2, row4_y - 8 * App.slope, 2)).addBridge(List.of(4, row5_y, 3))
                .addBridge(List.of(7, row5_y - App.slope, 3)).addBridge(List.of(10, row5_y - 2 * App.slope, 3))
                .addBridge(List.of(13, row5_y - 3 * App.slope, 3)).addBridge(List.of(16, row5_y - 4 * App.slope, 3))
                .addBridge(List.of(19, row5_y - 5 * App.slope, 3)).addBridge(List.of(22, row5_y - 6 * App.slope, 3))
                .addBridge(List.of(25, row5_y - 7 * App.slope, 3)).addBridge(List.of(28, row5_y - 8 * App.slope, 2))
                .addBridge(List.of(25, row6_y, 3)).addBridge(List.of(22, row6_y - App.slope, 3))
                .addBridge(List.of(19, row6_y - 2 * App.slope, 3)).addBridge(List.of(16, row6_y - 3 * App.slope, 3))
                .addBridge(List.of(2, row6_y - 4 * App.slope, 14))
                .addBridge(List.of(13, row6_y - 4 * App.section_height, 6))
                .addBridge(List.of(10, row6_y - 3 * App.section_height, 3))
                .addLadder(List.of(12, row2_y + 6 * App.slope, 2)).addLadder(List.of(12, row2_y + 26 * App.slope, 2))
                .addLadder(List.of(25, row2_y + 11 * App.slope, 4)).addLadder(List.of(6, row3_y + 11 * App.slope, 3))
                .addLadder(List.of(14, row3_y + 8 * App.slope, 4)).addLadder(List.of(10, row4_y + 6 * App.slope, 1))
                .addLadder(List.of(10, row4_y + 24 * App.slope, 2)).addLadder(List.of(16, row4_y + 6 * App.slope, 5))
                .addLadder(List.of(25, row4_y + 9 * App.slope, 4)).addLadder(List.of(6, row5_y + 11 * App.slope, 3))
                .addLadder(List.of(11, row5_y + 8 * App.slope, 4)).addLadder(List.of(23, row5_y + 4 * App.slope, 1))
                .addLadder(List.of(23, row5_y + 24 * App.slope, 2)).addLadder(List.of(25, row6_y + 9 * App.slope, 4))
                .addLadder(List.of(13, row6_y + 5 * App.slope, 2)).addLadder(List.of(13, row6_y + 25 * App.slope, 2))
                .addLadder(List.of(18, row6_y - 27 * App.slope, 4)).addLadder(List.of(12, row6_y - 17 * App.slope, 2))
                .addLadder(List.of(10, row6_y - 17 * App.slope, 2)).addLadder(List.of(12, -5, 13))
                .addLadder(List.of(10, -5, 13))
                .addHammer(List.of(3 * App.section_width, row6_top + App.section_height))
                .addHammer(List.of(3 * App.section_width, row4_top + App.section_height))
                .setTarget(List.of(10, row6_y - 7 * App.section_height, 3))
                .build());

        // Create level 2
        levels.add(new Level.Builder(root)
                .setBridgeColor(Color.BLUE)
                .addBridge(List.of(1, start_y, 15)).addBridge(List.of(16, start_y - App.slope, 3))
                .addBridge(List.of(19, start_y - 2 * App.slope, 3)).addBridge(List.of(22, start_y - 3 * App.slope, 3))
                .addBridge(List.of(25, start_y - 4 * App.slope, 3)).addBridge(List.of(28, start_y - 5 * App.slope, 3))
                .addBridge(List.of(25, row2_y, 3)).addBridge(List.of(22, row2_y - App.slope, 3))
    ...
    public Rectangle drawOil() {
        ...
        Rectangle oilTop = new Rectangle(x_coord - 0.1 * App.section_width, y_coord, 2.2 * App.section_width,
                .2 * App.section_height);
        oilTop.setFill(Color.BLUE);
        Rectangle oilBottom = new Rectangle(x_coord - 0.1 * App.section_width, y_coord + 2.3 * App.section_height,
                2.2 * App.section_width, .2 * App.section_height);
        oilBottom.setFill(Color.BLUE);
        Rectangle x = new Rectangle(x_coord + 0.1 * App.section_width, y_coord + .2 * App.section_height,
                .2 * App.section_width, 2 * App.section_height);
        x.setFill(Color.LIGHTBLUE);
        Rectangle y = new Rectangle(x_coord, y_coord + 0.5 * App.section_height, 2 * App.section_width,
                .2 * App.section_height);
        y.setFill(Color.LIGHTBLUE);
        Rectangle z = new Rectangle(x_coord, y_coord + 1.7 * App.section_height, 2 * App.section_width,
                .2 * App.section_height);
        ...
        // Draw 4 Red Circles
        for (int i = 0; i < 4; i++) {
            Circle circle = new Circle(x_coord + 0.5 * App.section_width + i * 0.4 * App.section_width,
                    y_coord + 2.1 * App.section_height, 3);
